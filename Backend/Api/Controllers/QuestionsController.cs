...
namespace Api.Controllers
{
    ...
    public class QuestionsController : ControllerBase
    {
        ...
        private readonly Application.Services.AuditService _auditService;
        private readonly IPermissionService _permissionService;

        public QuestionsController(QuestionService questionService, IAuthService authService, Application.Services.AuditService auditService, IPermissionService permissionService)
        {
